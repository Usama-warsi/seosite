            ...
            return [
                ...
                "metaRefreshExplainer" => "This test will check if your webpage is using a refresh meta tag. This tag causes a web page to refresh automatically after a specified amount of time. Users generally don't expect automatic refreshes, so they can be disorienting. Refreshing also moves focus to the top of the page, which may frustrate or confuse users, particularly those who rely on screen readers or other assistive technologies.",
                "refreshFailed" => "This webpage is using the Refresh meta tag!",
                "refreshPassed" => "This webpage is not using the Refresh meta tag!",
                
                "flashobject" => "Flash Test",
                "flashobjectExplainer" => "Check if your page uses Flash, an outdated technology that was typically used to deliver rich multimedia content. The web has evolved to replace Flash with open-standard technologies that additionally offered better performance and security. Flash content also does not work well on mobile devices, and is difficult to index by search engines.",
                "flashobjectPassed" => "This webpage does not include flash objects (an outdated technology that was sometimes used to deliver rich multimedia content). Flash content does not work well on mobile devices, and is difficult for crawlers to interpret.",
                "flashobjectFailed" => "This webpage include flash objects (an outdated technology that was sometimes used to deliver rich multimedia content). Flash content does not work well on mobile devices, and is difficult for crawlers to interpret.",
                
                
                
                  "mobileresponse" => "Mobile Snapshot & Responsiveness",
                "mobileresponseExplainer" => "Check how your website renders on a mobile device.",
                 "mediaqueryPassed" => "This webpage is using CSS media queries, which is the base for responsive design functionalities.",
                "mediaqueryFailed" => "This webpage is not using CSS media queries, which is the base for responsive design functionalities.",
                
                 "cssminification" => "CSS Minification",
                 "cssminificationtotallinks" => "This webpage has total :count  Css links",
                 "minimizedlink" => "Css Minimized Links",
                 "unminimizedlink" => "Css Unminimized Links",
                 "cssminificationExplainer" => "Checks if any CSS files used in your page is minified. Minified files reduce page size and overall load time.",
                    
                "sitecaching" => "Page Cache Test (Server Side Caching)",
                 "sitecachingPassed" => "This webpage is using a caching mechanism. Caching helps speed page loading times as well as reduces server load.",
                 "sitecachingFailed" => "This webpage is not using a caching mechanism. Caching helps speed page loading times as well as reduces server load.",
                 "sitecachingExplainer" => "Check if your page is serving cached pages. A page cache saves dynamically generated pages and serves the pre-generated (cached) page to reduce server load and site loading time (by avoiding the re-loading and execution of PHP scripts). Common caching methods are ZenCache and WP Rocket.",
                
                 "cdnusage" => "CDN Usage Test",
                 "cdnusagePassed" => "This webpage is serving all resources (images, javascript and css) from CDNs!",
                 "cdnusageFailed" => "This webpage is not serving all resources (images, javascript and css) from CDNs!",
                 "cdnusageExplainer" => "Check if your webpage's resources (images, javascript and css files) are served via CDNs.",
                
                    
                 "csscaching" => "CSS Caching",
                 "cachePassed" => "This webpage is using cache headers for all CSS resources.",
                 "cacheFailed" => "This webpage is not using cache headers for all CSS resources.",
                 "csscachingtotallinks" => "This webpage has total :count  Css links",
                 "cachelink" => "Css Cache Links",
                 "uncachelink" => "Css Uncache Links",
                 "csscachingExplainer" => "Checks if your page is using caching headers for all CSS resources. Users browsers will check for these headers and, if any, will cache the CSS resources until the specified date (so that it does not keep re-fetching the unchanged file from your server). This speeds up your site the next time returning visitors arrive at your site and require the same CSS resource.",
                
                 "jsminification" => "JavaScript Minification",
                 "jsminificationtotallinks" => "This webpage has total :count  JavaScript links",
                 "jsminimizedlink" => "JavaScript Minimized Links",
                 "jsunminimizedlink" => "JavaScript Unminimized Links",
                 "jsminificationExplainer" => "Checks if any JavaScript files used in your page is minified. Minified files reduce page size and overall load time.",
            
                 "jscaching" => "JavaScript Caching",
                 "jscachePassed" => "This webpage is using cache headers for all JavaScript resources.",
                 "jscacheFailed" => "This webpage is not using cache headers for all JavaScript resources.",
                 "jscachingtotallinks" => "This webpage has total :count  JavaScript links",
                 "jscachelink" => "JavaScript Cache Links",
                 "jsuncachelink" => "JavaScript Uncache Links",
                 "jscachingExplainer" => "Checks if your page is using caching headers for all JavaScript resources. Users browsers will check for these headers and, if any, will cache the JavaScript resources until the specified date (so that it does not keep re-fetching the unchanged file from your server). This speeds up your site the next time returning visitors arrive at your site and require the same JavaScript resource.",
            
                
                 "imgcaching" => "Image Caching",
                 "imgcachePassed" => "This webpage is using cache headers for all Image resources.",
                 "imgcacheFailed" => "This webpage is not using cache headers for all Image resources.",
                 "imgcachingtotallinks" => "This webpage has total :count  Image links",
                 "imgcachelink" => "Image Cache Links",
                 "imguncachelink" => "Image Uncache Links",
                 "imgcachingExplainer" => "Checks if your page is using an image expires tag, which specifies a future expiration date for your images. Browsers will see this tag and cache the image until the specified date (it doesn't re-fetch the unchanged image from your server). This speeds up your site the next time returning visitors arrive at your site and require the same image.",
            
            
                
                "metacanonical" => "Meta Canonical",
                "metaCanonicalExplainer" => "Check if your webpage is using the canonical link tag. The canonical link tag is used to nominate a primary page when you have several pages with duplicate or very similar content.",
                 "canonicaltagPassed" => "This webpage is using the Canonical meta tag!",
                "canonicaltagFailed" => "This webpage is not using the Canonical meta tag!",
                ...
                "googleSearchPreviewexplainer"        => "A Google Search Preview is a brief summary in search results, with two lines of text offering a snapshot of a web page's content. It includes the page title and a snippet, helping users decide if it's relevant before clicking. It assists users in making informed choices about which results to investigate further.",
                ...
                "pageSize" => "Page Size",
                "pagesizePassedCount" => 'This webpage\'s HTML is smaller than the average, clocking in <strong>:size</strong> as opposed to the <strong>typical :max.</strong> Websites that load quickly provide a superior user experience, and tend to have higher conversion rates and better search engine rankings.',
                ...
                "nofollowExplainer" => "The nofollow tag is an HTML attribute that can be added to a link to prevent search engines from following it",
                ...
                "noindexExplainer" => "The noindex tag is an HTML attribute that can be added to a page's <head> section to prevent search engines from indexing it.",
                ...
                "googlesiteverification" =>"Google Site Verification",
                 "googlesiteverificationexplainer" =>"Google Site Verification is a process that allows website owners to prove ownership or control over their website to Google. It involves adding a unique verification code or meta tag provided by Google to the website's HTML code or domain settings.",
                "googlesiteverificationPassed" =>"Google site verification found!",
                "googlesiteverificationFailed" => "Google site verification not found.",
                "directorybrowsering" =>"Directory Browsering Check",
                "directorybrowseringexplainer" =>"Directory browsing is a feature that allows users to view the contents of directories (folders) on a web server. It displays a list of files and subdirectories within a directory when an index file, such as index.html or index.php, is not present. Directory browsing can be enabled or disabled by the server configuration and is often restricted for security reasons to prevent unauthorized access to directory contents.",
                "directorybrowseringPassed" =>"Directory Browsering is Enable",
                "directorybrowseringFailed" => "Directory Browsering is Disable",
                 "jsexecution" =>"JavaScript execution time",
                "jsexecutionexplainer" =>"Consider reducing the time spent parsing, compiling, and executing JS. You may find delivering smaller JS payloads helps with this. ",
                "jsexecutionPassed" =>"Java script execute fastely",
                "jsexecutionFailed" => "Java script take too much time to execute",
                 "cls" =>"Cumulative Layout Shift",
                "clsexplainer" =>"Cumulative Layout Shift measures the movement of visible elements within the viewport.",
                "clsPassed" =>"Cumulative Layout Shift Test Passed ",
                "clsFailed" => "Cumulative Layout Shift Test Failed",
                "console" =>"Console Errors",
                "consoleerrors" =>"Erros logged to the console",
                "consoleexplainer" =>"Errors logged to the console indicate unresolved problems. They can come from network request failures and other browser concerns. [Learn more about this errors in console diagnostic audit](https://developer.chrome.com/docs/lighthouse/best-practices/errors-in-console/)",
                "consolePassed" =>"No browser errors logged to the console",
                "consoleFailed" => "Browser errors were logged to the console",
                 "savebrowsering" =>"Safe Browsing Test",
                "savebrowseringexplainer" =>"Secure browsing is paramount, shielding personal data from prying eyes. Privacy measures fortify online experiences, empowering users to navigate safely.",
                "savebrowseringPassed" =>"The URL is safe to browse.",
                "savebrowseringFailed" => "The URL is not safe to browse.",
                "renderblocking" =>"Render Blocking Resources Test",
                "renderresources" =>"Render Blocking Resources",
                "renderblockingexplainer" =>"Resources are blocking the first paint of your page. Consider delivering critical JS/CSS inline and deferring all non-critical JS/styles.",
                "renderblockingPassed" =>"Eliminate render-blocking resources",
                "renderblockingFailed" => "Not Eliminate render-blocking resources",
                
                "imgmeta" =>"Image Metadata Test",
                "imgmetaExplainer" =>"This test will check if the images used in a webpage have large metadata (more than 16% of the image size). Image Metadata refers to additional information (thumbnails, comments, date-times, copyright, camera model and settings, geo location, etc) which is stored along with the image. Most of this information is useless to site visitors and isn't required by browsers to render images.",
                "imgmetaPassed" =>"This webpage is not using images with large metadata.",
                "imgmetaFailed" => "This webpage is using images with large metadata.",
            
                 "lcp" => "Largest Contentful Paint Test",
                "lcpPassedCount" => "The Largest Contentful Paint duration of this webpage is <strong>:time</strong> seconds. To provide a good user experience, sites should strive to have Largest Contentful Paint of <strong>2.5</strong> seconds or less.",
                "lcpFailedCount" => "The Largest Contentful Paint duration of this webpage is <strong>:time</strong> seconds. To provide a good user experience, sites should strive to have Largest Contentful Paint of <strong>2.5</strong> seconds or less.",
                "lcpExplainer" => "This test will check the Largest Contentful Paint (LCP) metric of the analyzed webpage. LCP is a Core Web Vitals metric that measures when the largest element (image or text block) of a given web page becomes visible within the viewport, relative to when the page first started loading. To provide a good user experience, sites should strive to have Largest Contentful Paint of 2.5 seconds or less.",
