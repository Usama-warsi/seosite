<x-user-profile heading="h1" :title="__('profile.plan')" :hero-class="$user->subscription ? '' : 'center mt-5'">
    ...
    @else
        <div class="row text-center">
            ...
            <div class="col-md-12 text-center mb-5" style="    display: flex;
    justify-content: center;">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1278 979.7"
                    ...
                    <g>
                        ...
                        <path
                            ...
                            style="fill:none;stroke:#4f46e5;stroke-width:2;stroke-miterlimit:10" />
                    </g>
                    <path
           ...
           <div class="mt-3 px-4">
                        <a href="{{ route('plans.list') }}" style="margin-bottom: 1rem;" class="btn h-9  space-x-2 bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                       
                          <span>@lang('tools.subscribeNow')</span>
</a>
                      </div>
        </div>
    @endif
