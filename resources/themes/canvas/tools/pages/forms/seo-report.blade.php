...
<style>
    .tpbanner__search{    z-index: 1;
    position: relative;}
</style>
<div class="tpbanner__search">
                           <form action="{{route('tool.handle','seo-report')}}" method="post">
                               @CSRF
                              <div class="tpbanner__form d-flex align-items-center" >
                                 <div class="tpbanner__input " style="width:70%">
                                    <input type="text" name="url" id="url" required placeholder="https:// yoursite.com">
                                    <span>
                                 ...
                                 <div class="tpbanner__search-btn" style="width:30%">
