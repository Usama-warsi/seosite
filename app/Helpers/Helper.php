...
if (!function_exists('generatemobScreenshot')) {
    /**
     * Screenshot URL generator
     *
     * @param string $url
     ...
     * @return void
     */
  function generatemobScreenshot(string $url)
{
   ...
   // Send the HTTP request to the PageSpeed Insights API
   ...
   // You can uncomment the following lines if you want to save the screenshot to a file
   /*
